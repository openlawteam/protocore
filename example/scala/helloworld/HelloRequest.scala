...
final case class HelloRequest(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): helloworld.HelloRequest = {
    ...
    def companion = helloworld.HelloRequest
}
...
object HelloRequest extends scalapb.GeneratedMessageCompanion[helloworld.HelloRequest] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): helloworld.HelloRequest = {
